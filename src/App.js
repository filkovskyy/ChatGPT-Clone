        ...
        <>
            <div className="app">
                <section className="side-bar">
                    <button id="new-chat-btn" onClick={createNewChat}><span><i className="fa-solid fa-plus"></i>New chat</span>
                    </button>
                        ...
                        <div className="grid-container">
                            <div className="grid-column first">
                                ...
                                <ul className="chat-overview">
                                    ...
                                    <li className="examples">
                                        <button>"Got any creative ideas for a 10 year old’s birthday?"
                                            →
                                        </button>
                                    </li>
                                    <li className="examples">
                                        <button>"How do I make an HTTP request in Javascript?" →
                                        </button>
                                    </li>
                                </ul>
                            </div>
